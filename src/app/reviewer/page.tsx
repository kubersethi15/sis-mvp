      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">Three-Gate Hiring Pipeline — Live Data</p>
          </div>
          <div className="flex items-center gap-3">
            <button onClick={fetchData} className="text-xs text-blue-600 hover:text-blue-700 font-medium">🔄 Refresh</button>
